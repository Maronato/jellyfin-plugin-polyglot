...
public class MirrorSyncTask : IScheduledTask
{
    ...
    public async Task ExecuteAsync(IProgress<double> progress, CancellationToken cancellationToken)
    {
        ...
        foreach (var alternativeId in alternativeIds)
        {
            ...
            _logger.PolyglotInfo("MirrorSyncTask: Syncing mirrors for alternative: {0}", alternativeEntity);
            ...
            try
            {
                ...
                {
                    _logger.PolyglotWarning("MirrorSyncTask: Alternative {0} was deleted during sync", alternativeEntity);
                }
            ...
            {
                _logger.PolyglotError(ex, "MirrorSyncTask: Failed to sync alternative: {0}", alternativeEntity);
            }
